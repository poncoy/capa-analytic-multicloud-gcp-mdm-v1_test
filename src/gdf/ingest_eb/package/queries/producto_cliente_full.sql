...
FROM
  `{PROJECT_ID}.lan_mdm_ingesta.PER__cliente_persona` cp
  INNER JOIN `{PROJECT_ID}.lan_mdm_ingesta.PER__cliente_persona_detalle` cpd ON cp.id_cliente_persona = cpd.id_cliente_persona
